...
def force_single_tab_navigation_v186():
    """v193: disabled browser JS. Navigation uses Streamlit buttons only."""
    return
...
/* v205: keep Home hero buttons in their original place and make them clickable */
.hero-buttons-clickable-v205 {
    display: flex !important;
    align-items: center !important;
    gap: 12px !important;
    margin-top: 28px !important;
...
/* v209 premium credentials and footer only */
.credentials-section-v209 {
    background: linear-gradient(180deg, #F8FBFF 0%, #EFF6FF 100%) !important;
    padding: 54px 56px 50px 56px !important;
    position: relative !important;
    overflow: hidden !important;
}
.credentials-section-v209:before {
    content: "" !important;
    position: absolute !important;
    inset: auto 0 0 0 !important;
    height: 120px !important;
    background: radial-gradient(ellipse at left bottom, rgba(0,91,219,.10), transparent 55%), radial-gradient(ellipse at right bottom, rgba(0,31,72,.08), transparent 60%) !important;
    pointer-events: none !important;
}
.credentials-grid-v209 {
    position: relative !important;
    z-index: 2 !important;
    display: grid !important;
    grid-template-columns: repeat(4, minmax(0, 1fr)) !important;
...
.credential-card-v209 {
    background: rgba(255,255,255,.92) !important;
    border: 1px solid rgba(220,230,244,.95) !important;
    border-radius: 22px !important;
...
.credential-card-v209:hover {
    transform: translateY(-3px) !important;
    box-shadow: 0 24px 52px rgba(16,24,40,.12) !important;
}
.credential-logo-wrap-v209,
.credential-logo-placeholder-v209 {
    width: 120px !important;
    height: 120px !important;
    border-radius: 50% !important;
...
.credential-scholarship-icon-v209 svg {
    width: 104px !important;
    height: 104px !important;
    display: block !important;
}
.credential-card-v209 h3 {
    color: #061A40 !important;
    -webkit-text-fill-color: #061A40 !important;
    font-size: 21px !important;
    line-height: 1.25 !important;
...
.credential-line-v209,
.footer-blue-line-v209 {
...
.premium-footer-v209 {
    position: relative !important;
    overflow: hidden !important;
    background: linear-gradient(135deg, #00142F 0%, #002A5E 58%, #001A3E 100%) !important;
    color: #FFFFFF !important;
...
.footer-map-pattern-v209 {
    ...
    opacity: .20 !important;
    background:
      radial-gradient(circle at 20% 40%, rgba(255,255,255,.9) 1.2px, transparent 1.8px),
      radial-gradient(circle at 38% 44%, rgba(255,255,255,.8) 1.1px, transparent 1.8px),
      radial-gradient(circle at 56% 38%, rgba(255,255,255,.7) 1.1px, transparent 1.8px),
      radial-gradient(circle at 75% 45%, rgba(255,255,255,.9) 1.2px, transparent 1.8px);
    background-size: 18px 18px, 16px 16px, 15px 15px, 18px 18px !important;
    border-radius: 50% !important;
...
.premium-footer-grid-v209 {
    ...
    z-index: 2 !important;
    display: grid !important;
    grid-template-columns: 1.35fr .85fr 1.05fr .95fr !important;
    gap: 0 !important;
    max-width: 1480px !important;
    margin: 0 auto !important;
}
.footer-brand-v209,
.footer-contact-card-v209 {
    padding: 0 32px !important;
    border-right: 1px solid rgba(255,255,255,.13) !important;
}
.footer-contact-card-v209:last-child {border-right: 0 !important;}
.footer-brand-v209 {padding-left: 0 !important;}
.footer-brand-v209 h3 {
    color: #FFFFFF !important;
    -webkit-text-fill-color: #FFFFFF !important;
    font-size: 26px !important;
    line-height: 1.25 !important;
...
.footer-blue-line-v209.small {
    margin: 12px 0 18px 0 !important;
    width: 34px !important;
}
.footer-brand-v209 p,
.footer-contact-card-v209 p {
...
@media(max-width:1200px) {
    .credentials-grid-v209 {grid-template-columns: repeat(2, minmax(0, 1fr)) !important;}
    .premium-footer-grid-v209 {grid-template-columns: repeat(2, minmax(0, 1fr)) !important; row-gap: 42px !important;}
    .footer-brand-v209, .footer-contact-card-v209 {border-right: 0 !important; padding: 0 22px !important;}
    .footer-brand-v209 {padding-left: 22px !important;}
}
@media(max-width:760px) {
    .credentials-section-v209 {padding: 36px 20px !important;}
    .credentials-grid-v209 {grid-template-columns: 1fr !important; gap: 18px !important;}
    .credential-card-v209 {min-height: auto !important; padding: 30px 22px !important;}
    .premium-footer-v209 {padding: 44px 22px 0 22px !important;}
    .premium-footer-grid-v209 {grid-template-columns: 1fr !important; gap: 34px !important;}
    .footer-brand-v209, .footer-contact-card-v209 {padding: 0 !important;}
    .premium-footer-bottom-v209 {flex-direction: column !important; align-items: flex-start !important; margin-top: 42px !important;}
    .footer-bottom-links-v209 {gap: 14px !important;}
...
/* v223: fix only marked navbar, hero, and filter area */

/* Remove the empty markdown shells that appeared as thin rounded blank bars */
.top-nav-button-shell-v187,
.uni-filter-panel-v214{
    display:none !important;
    height:0 !important;
...
/* Style the actual Streamlit horizontal block that contains the public navbar */
...
.premium-public-brand-mark-v223{
    ...
    align-items:center !important;
    justify-content:center !important;
    background:linear-gradient(135deg,#3F5BD6,#061A40) !important;
    color:#fff !important;
    -webkit-text-fill-color:#fff !important;
    font-size:16px !important;
    box-shadow:0 10px 22px rgba(6,26,64,.22) !important;
}
...
/* Active Universities item in public navbar */
...
/* Login secondary and Partner Sign Up primary */
...
/* Hero: less empty, stronger premium background */
.uni-list-heading-v214{
    min-height:0 !important;
    ...
    background:
      radial-gradient(circle at 72% 30%, rgba(63,91,214,.18), transparent 27%),
      radial-gradient(circle at 92% 10%, rgba(14,165,233,.12), transparent 22%),
      linear-gradient(135deg,#FFFFFF 0%,#F7FBFF 42%,#EEF5FF 100%) !important;
...
.uni-list-heading-v214::before{
    ...
    inset:0 !important;
    background:
      repeating-linear-gradient(135deg, rgba(30,58,138,.06) 0 1px, transparent 1px 15px),
      radial-gradient(ellipse at 78% 58%, rgba(6,26,64,.06), transparent 34%) !important;
    pointer-events:none !important;
}
.uni-hero-copy-v223,
.uni-list-heading-v214 .how-it-works-v214{
...
/* Style the actual Streamlit filter row as one search/filter card */
...
div[data-testid="stHorizontalBlock"]:has(input[placeholder*="Search university"]) div[data-testid="stButton"] > button{
    ...
    font-weight:900 !important;
    font-size:15px !important;
    box-shadow:0 10px 24px rgba(6,26,64,.20) !important;
}

/* Keep info bar clean below filters */
.uni-info-bar-v214{
    margin-top:0 !important;
    margin-bottom:24px !important;
}
...
/* v231: navbar-to-hero spacing and hero height fix only */
:root{
    --v231-content-width: 1480px;
}

/* Reduce Streamlit default top/section spacing around the public Universities page */
.block-container{
    padding-top: 1.15rem !important;
}

/* Navbar: keep one line, reduce bottom gap */
div[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223),
div[data-testid="stHorizontalBlock"]:has(.public-brand-v220),
div[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225){
    width: calc(100% - 56px) !important;
    max-width: var(--v231-content-width) !important;
    margin: 10px auto 20px auto !important;
    padding: 0 !important;
    align-items: center !important;
}

/* Remove large blank vertical spacer between navbar and hero */
...
/* Tighten the area directly below hero before filters */
.uni-hero-wrap-v230 + div,
div[data-testid="stVerticalBlock"] > div:has(.uni-hero-wrap-v230) + div{
    margin-top: 0 !important;
    padding-top: 0 !important;
}

/* Filter section should sit close to hero */
div[data-testid="stHorizontalBlock"]:has(input[placeholder*="Search university"]),
...
/* Make sure there is no oversized hidden old hero creating space */
.uni-list-heading-v226,
.uni-list-heading-v227,
.uni-list-heading-v228,
.uni-hero-wrap-v229,
...
/* Navbar button polish only */
div[data-testid="column"]:has(.nav-signup-marker-v225) div[data-testid="stButton"] > button{
    background:#061A40 !important;
    border-color:#061A40 !important;
    color:#FFFFFF !important;
    -webkit-text-fill-color:#FFFFFF !important;
    box-shadow:0 12px 26px rgba(6,26,64,.16) !important;
}
div[data-testid="column"]:has(.nav-login-marker-v225) div[data-testid="stButton"] > button{
    background:#FFFFFF !important;
    color:#061A40 !important;
...
/* v232: remove remaining vertical gap and make hero taller/fuller */
.block-container{
    padding-top: .35rem !important;
}

/* Pull navbar and hero together */
div[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223),
div[data-testid="stHorizontalBlock"]:has(.public-brand-v220),
div[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225){
    width: calc(100% - 56px) !important;
...
/* Remove the large empty white band before hero */
.uni-hero-wrap-v230{
    width: calc(100% - 56px) !important;
    max-width: 1480px !important;
...
/* Force the iframe itself to occupy a larger hero area */
.uni-hero-wrap-v230 iframe{
    width: 100% !important;
...
/* If Streamlit wraps the iframe in extra containers, remove their vertical spacing */
div[data-testid="stVerticalBlock"] > div:has(.uni-hero-wrap-v230),
...
/* Keep filters close under the bigger hero */
div[data-testid="stHorizontalBlock"]:has(input[placeholder*="Search university"]),
div[data-testid="stHorizontalBlock"]:has(input[placeholder*="Search universities"]){
    width: calc(100% - 56px) !important;
    max-width: 1480px !important;
...
/* Make hero feel fuller on larger screens */
...
/* v240: WIDE shared container based on the hero width. Do not shrink hero. */
:root{
    --v240-page-width: calc(100% - 48px);
    --v240-page-max: 1720px;
}

/* Let the page use full browser width; the shared container controls side spacing */
.block-container,
section.main > div,
main .block-container{
    max-width: 100% !important;
...
/* Navbar: enlarge to match the wider hero width */
div[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223),
div[data-testid="stHorizontalBlock"]:has(.public-brand-v220),
div[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225){
    width: var(--v240-page-width) !important;
    max-width: var(--v240-page-max) !important;
...
/* Hero: restore/keep wide hero width as the standard */
.uni-hero-wrap-v230{
    width: var(--v240-page-width) !important;
    max-width: var(--v240-page-max) !important;
    margin: 0 auto 0 auto !important;
...
/* Streamlit component iframe must use the same WIDE width, not 1440px */
div[data-testid="stElementContainer"]:has(iframe),
div[data-testid="stIFrame"],
div[data-testid="stIFrame"] > div,
.uni-hero-wrap-v230 iframe,
...
/* Keep hero height/logic unchanged; just remove extra vertical reserve */
.uni-hero-wrap-v230 iframe,
div[data-testid="stIFrame"] iframe,
div[data-testid="stElementContainer"]:has(iframe) iframe,
iframe{
...
/* Filter card: stretch to match hero width */
div[data-testid="stHorizontalBlock"]:has(input[placeholder*="Search university"]),
div[data-testid="stHorizontalBlock"]:has(input[placeholder*="Search universities"]){
    width: var(--v240-page-width) !important;
    max-width: var(--v240-page-max) !important;
...
/* University grid/list wrappers: match hero width */
.university-grid-wrapper,
.university-grid,
.universities-grid,
.universities-grid-wrapper,
...
/* Hide older unused hero blocks/spacers without touching current slider logic */
.uni-list-heading-v226,
.uni-list-heading-v227,
.uni-list-heading-v228,
.uni-hero-wrap-v229,
...
/* Make sure hero content fills the iframe/container and does not use a smaller max-width */
.hero-section,
.hero-slider,
.hero-promo-slider-v230,
.hero-promo-slider-v231,
...
def browser_login_nav_sync_v163():
    """v193: disabled browser localStorage/JS sync to stop unwanted new tabs."""
    return
...
def header():
    ...
    """
    # v193: no URL-auth restore inside header.
    ...
    def _logout_v187():
        # v189: no browser JS logout script; clear Streamlit session only.
        for k in [
    ...
    if logged_in_v187:
        ...
        # Public view
        # v246: Login and Partner Sign Up are real styled navbar action links, not plain Streamlit text buttons.
        # They use same-tab query navigation handled by handle_top_nav_query_v70().
        nav_cols = st.columns([1.75, .82, 1.08, 1.36, 1.18, 1.06, 1.14, 2.55], gap="small")
        with nav_cols[0]:
            st.markdown(
                '<div class="premium-public-brand-v223">'
                '<div class="premium-public-brand-mark-v223">◆</div>'
        ...
        with nav_cols[7]:
            st.markdown(
                """
                <div class="nav-actions-v246">
                  <a href="?nav=login" class="login-button-v246" target="_self" rel="nofollow">
                    <span class="nav-action-icon-v246">👤</span>
                    <span>Login</span>
                  </a>
                  <a href="?nav=signup" class="partner-signup-button-v246" target="_self" rel="nofollow">
                    <span class="nav-action-icon-v246">👥</span>
...
def _footer_badge_icon_html_v197(asset_path, alt_text="badge"):
    ...
    if not encoded:
        return '<div class="credential-logo-placeholder-v209">Logo</div>'
...
def home():
    ...
    <section class="hero-reference-v69" style="{bg}">
      ...
      <div class="hero-inner-v69">
        ...
        <div class="hero-buttons-v69 hero-buttons-clickable-v205">
          <form method="get" target="_self" class="hero-form-v205">
            <input type="hidden" name="go" value="signup">
            <button type="submit" class="hero-btn-primary-v69 hero-button-real-v205">👤&nbsp;&nbsp;Apply for Partner Access</button>
          </form>
          <form method="get" target="_self" class="hero-form-v205">
            <input type="hidden" name="go" value="universities">
            <button type="submit" class="hero-btn-outline-v69 hero-button-real-v205">🏛️&nbsp;&nbsp;Explore Universities</button>
          </form>
        </div>
...
def hero_slider_component_html_v230(df):
    ...
    <script>
    function v243ReferenceSpacingFix(){{
        try{{
            var frame = window.frameElement;
            if(!frame){{ return; }}
            var doc = window.parent && window.parent.document ? window.parent.document : document;
            ...
            function adjust(){{
                try{{
                    if(nav){{
                        ...
                        var gapTop = fr.top - nr.bottom;
                        if(gapTop > 18){{
                            frame.style.marginTop = "-" + Math.min(gapTop - 14, 120) + "px";
                        }}else if(gapTop < 8){{
                    ...
                    if(filter){{
                        ...
                        var gapBottom = flr.top - fr2.bottom;
                        if(gapBottom > 18){{
                            frame.style.marginBottom = "-" + Math.min(gapBottom - 14, 160) + "px";
                        }}else if(gapBottom < 8){{
    ...
    window.addEventListener("load", v243ReferenceSpacingFix);
    window.addEventListener("resize", v243ReferenceSpacingFix);
    setTimeout(v243ReferenceSpacingFix, 50);
    setTimeout(v243ReferenceSpacingFix, 250);
    setTimeout(v243ReferenceSpacingFix, 800);
    setTimeout(v243ReferenceSpacingFix, 1600);
    </script>


<script>
function v244RemoveHiddenGaps(){{
  try{{
...
window.addEventListener("load", v244RemoveHiddenGaps);
window.addEventListener("resize", v244RemoveHiddenGaps);
setTimeout(v244RemoveHiddenGaps, 50);
setTimeout(v244RemoveHiddenGaps, 250);
setTimeout(v244RemoveHiddenGaps, 800);
setTimeout(v244RemoveHiddenGaps, 1500);
</script>
...
def render_universities_hero_v230(df):
    # v243: Render only the iframe component.
...
# v243 navbar/spacing/reference CSS injection
st.markdown('\n<style>\n/* v243: navbar style + remaining vertical gap/alignment fix only */\n:root{\n    --v243-page-width: calc(100% - 32px);\n    --v243-page-max: 1760px;\n    --v242-page-width: calc(100% - 32px);\n    --v242-page-max: 1760px;\n    --v241-page-width: calc(100% - 32px);\n    --v241-page-max: 1760px;\n}\n\n/* Remove default Streamlit page side padding so the shared container controls the width */\nhtml, body, [data-testid="stAppViewContainer"], [data-testid="stAppViewContainer"] > .main{\n    width:100% !important;\n    max-width:100% !important;\n    overflow-x:hidden !important;\n}\n.block-container,\nsection.main > div,\nmain .block-container,\n[data-testid="stMainBlockContainer"]{\n    width:100% !important;\n    max-width:100% !important;\n    padding-left:0 !important;\n    padding-right:0 !important;\n    padding-top:0 !important;\n    margin-left:0 !important;\n    margin-right:0 !important;\n    box-sizing:border-box !important;\n}\n\n/* Shared wide container for navbar, hero iframe, filter, info, and grid */\ndiv[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223),\ndiv[data-testid="stHorizontalBlock"]:has(.public-brand-v220),\ndiv[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225),\ndiv[data-testid="stElementContainer"]:has(iframe),\ndiv[data-testid="stIFrame"],\ndiv[data-testid="stIFrame"] > div,\ndiv[data-testid="stHorizontalBlock"]:has(input[placeholder*="Search university"]),\ndiv[data-testid="stHorizontalBlock"]:has(input[placeholder*="Search universities"]),\ndiv[data-testid="stAlert"],\n.university-grid-wrapper,\n.university-grid,\n.universities-grid,\n.universities-grid-wrapper,\n.uni-card-grid,\n.uni-grid,\n.cards-grid,\n.university-list-wrapper,\n.universities-list-wrapper{\n    width:var(--v243-page-width) !important;\n    max-width:var(--v243-page-max) !important;\n    margin-left:auto !important;\n    margin-right:auto !important;\n    box-sizing:border-box !important;\n}\n\n/* Navbar like reference: clean white bar, one line, centered items */\ndiv[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223),\ndiv[data-testid="stHorizontalBlock"]:has(.public-brand-v220),\ndiv[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225){\n    min-height:74px !important;\n    align-items:center !important;\n    margin-top:8px !important;\n    margin-bottom:14px !important;\n    padding:10px 16px !important;\n    border:1px solid #E2E8F0 !important;\n    border-radius:18px !important;\n    background:rgba(255,255,255,.98) !important;\n    box-shadow:0 12px 32px rgba(15,23,42,.08) !important;\n    gap:8px !important;\n}\n\n/* Make Streamlit columns in navbar vertically centered */\ndiv[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223) > div,\ndiv[data-testid="stHorizontalBlock"]:has(.public-brand-v220) > div,\ndiv[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225) > div{\n    display:flex !important;\n    align-items:center !important;\n    justify-content:center !important;\n    min-height:54px !important;\n}\n\n/* Brand/logo area */\n.premium-public-brand-v223{\n    height:54px !important;\n    display:flex !important;\n    align-items:center !important;\n    gap:10px !important;\n    white-space:nowrap !important;\n    overflow:visible !important;\n}\n.premium-public-brand-mark-v223{\n    width:52px !important;\n    height:52px !important;\n    min-width:52px !important;\n    border-radius:14px !important;\n    background:linear-gradient(135deg,#3146B7 0%,#061A40 100%) !important;\n    box-shadow:0 10px 22px rgba(6,26,64,.22) !important;\n    color:transparent !important;\n    -webkit-text-fill-color:transparent !important;\n    position:relative !important;\n    overflow:hidden !important;\n}\n.premium-public-brand-mark-v223::before{\n    content:"KUA" !important;\n    position:absolute !important;\n    inset:0 !important;\n    display:flex !important;\n    align-items:center !important;\n    justify-content:center !important;\n    color:#fff !important;\n    -webkit-text-fill-color:#fff !important;\n    font-size:15px !important;\n    font-weight:950 !important;\n    letter-spacing:-.03em !important;\n}\n.premium-public-brand-mark-v223::after{\n    content:"" !important;\n    position:absolute !important;\n    left:13px !important;\n    right:13px !important;\n    top:8px !important;\n    height:5px !important;\n    border-top:2px solid rgba(255,255,255,.90) !important;\n    border-radius:50% !important;\n}\n.premium-public-brand-v223 strong{\n    display:block !important;\n    font-size:17px !important;\n    line-height:1.1 !important;\n    font-weight:900 !important;\n    letter-spacing:-.02em !important;\n    color:#0F172A !important;\n    -webkit-text-fill-color:#0F172A !important;\n}\n.premium-public-brand-v223 span{\n    display:block !important;\n    margin-top:3px !important;\n    font-size:13px !important;\n    line-height:1.1 !important;\n    font-weight:700 !important;\n    color:#475569 !important;\n    -webkit-text-fill-color:#475569 !important;\n}\n\n/* Navbar menu buttons: no floating, centered */\ndiv[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223) div[data-testid="stButton"],\ndiv[data-testid="stHorizontalBlock"]:has(.public-brand-v220) div[data-testid="stButton"],\ndiv[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225) div[data-testid="stButton"]{\n    width:100% !important;\n    display:flex !important;\n    align-items:center !important;\n}\ndiv[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223) div[data-testid="stButton"] > button,\ndiv[data-testid="stHorizontalBlock"]:has(.public-brand-v220) div[data-testid="stButton"] > button,\ndiv[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225) div[data-testid="stButton"] > button{\n    height:48px !important;\n    min-height:48px !important;\n    border-radius:12px !important;\n    border:1px solid transparent !important;\n    background:transparent !important;\n    color:#0F172A !important;\n    -webkit-text-fill-color:#0F172A !important;\n    font-size:14px !important;\n    font-weight:800 !important;\n    line-height:1 !important;\n    padding:0 12px !important;\n    white-space:nowrap !important;\n    display:flex !important;\n    align-items:center !important;\n    justify-content:center !important;\n    box-shadow:none !important;\n}\n\n/* Login button: outlined secondary */\ndiv[data-testid="column"]:has(.nav-login-marker-v225) div[data-testid="stButton"] > button{\n    height:48px !important;\n    border-radius:12px !important;\n    border:1px solid #CBD5E1 !important;\n    background:#FFFFFF !important;\n    color:#0F172A !important;\n    -webkit-text-fill-color:#0F172A !important;\n    font-weight:800 !important;\n    box-shadow:none !important;\n}\n\n/* Partner Sign Up button: navy primary */\ndiv[data-testid="column"]:has(.nav-signup-marker-v225) div[data-testid="stButton"] > button{\n    height:48px !important;\n    border-radius:12px !important;\n    border:1px solid #061A40 !important;\n    background:linear-gradient(135deg,#061A40 0%,#123B8A 100%) !important;\n    color:#FFFFFF !important;\n    -webkit-text-fill-color:#FFFFFF !important;\n    font-weight:900 !important;\n    box-shadow:0 10px 24px rgba(6,26,64,.22) !important;\n}\n\n/* Hero iframe: exact size, no unnecessary vertical reserve */\ndiv[data-testid="stElementContainer"]:has(iframe),\ndiv[data-testid="stIFrame"],\ndiv[data-testid="stIFrame"] > div{\n    margin-top:0 !important;\n    margin-bottom:0 !important;\n    padding-top:0 !important;\n    padding-bottom:0 !important;\n}\ndiv[data-testid="stIFrame"] iframe,\ndiv[data-testid="stElementContainer"]:has(iframe) iframe{\n    width:var(--v243-page-width) !important;\n    max-width:var(--v243-page-max) !important;\n    height:482px !important;\n    min-height:482px !important;\n    max-height:482px !important;\n    display:block !important;\n    margin-left:auto !important;\n    margin-right:auto !important;\n    margin-top:0 !important;\n    margin-bottom:0 !important;\n    padding:0 !important;\n    border:0 !important;\n}\n\n/* Filter card close under hero */\ndiv[data-testid="stHorizontalBlock"]:has(input[placeholder*="Search university"]),\ndiv[data-testid="stHorizontalBlock"]:has(input[placeholder*="Search universities"]){\n    margin-top:14px !important;\n    margin-bottom:14px !important;\n    padding:18px 18px !important;\n    border-radius:18px !important;\n}\n\n/* Remove blank blocks around hero/filter created by Streamlit markdown/elements */\ndiv[data-testid="stVerticalBlock"] > div:has(iframe),\ndiv[data-testid="stVerticalBlock"] > div:has(input[placeholder*="Search university"]),\ndiv[data-testid="stVerticalBlock"] > div:has(input[placeholder*="Search universities"]){\n    margin-top:0 !important;\n    margin-bottom:0 !important;\n    padding-top:0 !important;\n    padding-bottom:0 !important;\n}\n\n/* This is important: old wrapper no longer used, but if present it must not reserve space */\n.uni-hero-wrap-v230{\n    width:0 !important;\n    height:0 !important;\n    min-height:0 !important;\n    max-height:0 !important;\n    margin:0 !important;\n    padding:0 !important;\n    overflow:visible !important;\n}\n\n/* Info bar spacing */\ndiv[data-testid="stAlert"]{\n    margin-top:14px !important;\n    margin-bottom:20px !important;\n}\n\n/* Mobile */\n@media(max-width:768px){\n    :root{\n        --v243-page-width:calc(100% - 24px);\n        --v242-page-width:calc(100% - 24px);\n        --v241-page-width:calc(100% - 24px);\n    }\n    div[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223),\n    div[data-testid="stHorizontalBlock"]:has(.public-brand-v220),\n    div[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225){\n        padding:8px 10px !important;\n        margin-bottom:12px !important;\n    }\n    div[data-testid="stIFrame"] iframe,\n    div[data-testid="stElementContainer"]:has(iframe) iframe{\n        height:432px !important;\n        min-height:432px !important;\n        max-height:432px !important;\n    }\n}\n@media(max-width:480px){\n    :root{\n        --v243-page-width:calc(100% - 16px);\n        --v242-page-width:calc(100% - 16px);\n        --v241-page-width:calc(100% - 16px);\n    }\n    div[data-testid="stIFrame"] iframe,\n    div[data-testid="stElementContainer"]:has(iframe) iframe{\n        height:422px !important;\n        min-height:422px !important;\n        max-height:422px !important;\n    }\n}\n</style>\n', unsafe_allow_html=True)
...
# v245 navbar action buttons and alignment fix
st.markdown('\n<style>\n/* v245: navbar action buttons + one-line vertical alignment only */\n:root{\n    --v245-page-width: calc(100% - 32px);\n    --v245-page-max: 1760px;\n}\n\n/* Keep navbar wide and aligned with page container */\ndiv[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223),\ndiv[data-testid="stHorizontalBlock"]:has(.public-brand-v220),\ndiv[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225){\n    width: var(--v245-page-width) !important;\n    max-width: var(--v245-page-max) !important;\n    min-height: 76px !important;\n    height: 76px !important;\n    margin: 6px auto 10px auto !important;\n    padding: 10px 16px !important;\n    display: flex !important;\n    align-items: center !important;\n    justify-content: space-between !important;\n    gap: 10px !important;\n    border: 1px solid #E2E8F0 !important;\n    border-radius: 18px !important;\n    background: rgba(255,255,255,.98) !important;\n    box-shadow: 0 12px 32px rgba(15,23,42,.08) !important;\n    box-sizing: border-box !important;\n    overflow: visible !important;\n}\n\n/* Every navbar column vertically centered */\ndiv[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223) > div,\ndiv[data-testid="stHorizontalBlock"]:has(.public-brand-v220) > div,\ndiv[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225) > div{\n    height: 56px !important;\n    min-height: 56px !important;\n    display: flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    padding-top: 0 !important;\n    padding-bottom: 0 !important;\n    margin-top: 0 !important;\n    margin-bottom: 0 !important;\n    box-sizing: border-box !important;\n}\n\n/* Brand stays compact and centered */\n.premium-public-brand-v223,\n.public-brand-v220{\n    height: 56px !important;\n    min-height: 56px !important;\n    display: flex !important;\n    align-items: center !important;\n    gap: 10px !important;\n    white-space: nowrap !important;\n    margin: 0 !important;\n    padding: 0 !important;\n}\n.premium-public-brand-mark-v223,\n.public-brand-mark-v220{\n    width: 54px !important;\n    height: 54px !important;\n    min-width: 54px !important;\n    min-height: 54px !important;\n    border-radius: 14px !important;\n    display: flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    margin: 0 !important;\n}\n\n/* Normalize all navbar Streamlit button wrappers */\ndiv[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223) div[data-testid="stButton"],\ndiv[data-testid="stHorizontalBlock"]:has(.public-brand-v220) div[data-testid="stButton"],\ndiv[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225) div[data-testid="stButton"]{\n    width: 100% !important;\n    height: 48px !important;\n    min-height: 48px !important;\n    display: flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    margin: 0 !important;\n    padding: 0 !important;\n}\ndiv[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223) div[data-testid="stButton"] > button,\ndiv[data-testid="stHorizontalBlock"]:has(.public-brand-v220) div[data-testid="stButton"] > button,\ndiv[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225) div[data-testid="stButton"] > button{\n    height: 48px !important;\n    min-height: 48px !important;\n    max-height: 48px !important;\n    margin: 0 !important;\n    padding: 0 14px !important;\n    border-radius: 12px !important;\n    line-height: 1 !important;\n    display: inline-flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    gap: 8px !important;\n    font-size: 15px !important;\n    font-weight: 800 !important;\n    white-space: nowrap !important;\n    transform: none !important;\n    position: static !important;\n    top: auto !important;\n    box-sizing: border-box !important;\n}\n\n/* Normal nav menu items stay text-like but vertically centered */\ndiv[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223) div[data-testid="stButton"] > button:not(:has(.nav-login-marker-v225)):not(:has(.nav-signup-marker-v225)),\ndiv[data-testid="stHorizontalBlock"]:has(.public-brand-v220) div[data-testid="stButton"] > button:not(:has(.nav-login-marker-v225)):not(:has(.nav-signup-marker-v225)){\n    background: transparent !important;\n    border: 1px solid transparent !important;\n    box-shadow: none !important;\n    color: #0F172A !important;\n    -webkit-text-fill-color: #0F172A !important;\n}\n\n/* Login column and button: outlined secondary */\ndiv[data-testid="column"]:has(.nav-login-marker-v225),\ndiv[data-testid="column"]:has(.nav-login-marker-v225) > div{\n    display: flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    height: 56px !important;\n    min-height: 56px !important;\n    margin: 0 !important;\n    padding: 0 !important;\n}\ndiv[data-testid="column"]:has(.nav-login-marker-v225) div[data-testid="stButton"] > button{\n    height: 48px !important;\n    min-height: 48px !important;\n    padding: 0 22px !important;\n    border-radius: 12px !important;\n    border: 1px solid #CBD5E1 !important;\n    background: #FFFFFF !important;\n    color: #0F172A !important;\n    -webkit-text-fill-color: #0F172A !important;\n    font-size: 15px !important;\n    font-weight: 850 !important;\n    box-shadow: none !important;\n}\ndiv[data-testid="column"]:has(.nav-login-marker-v225) div[data-testid="stButton"] > button p::before{\n    content: "👤";\n    margin-right: 8px;\n    font-size: 15px;\n}\n\n/* Partner Sign Up column and button: navy primary */\ndiv[data-testid="column"]:has(.nav-signup-marker-v225),\ndiv[data-testid="column"]:has(.nav-signup-marker-v225) > div{\n    display: flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    height: 56px !important;\n    min-height: 56px !important;\n    margin: 0 !important;\n    padding: 0 !important;\n}\ndiv[data-testid="column"]:has(.nav-signup-marker-v225) div[data-testid="stButton"] > button{\n    height: 48px !important;\n    min-height: 48px !important;\n    padding: 0 24px !important;\n    border-radius: 12px !important;\n    border: 1px solid #061A40 !important;\n    background: linear-gradient(135deg, #061A40 0%, #123B8A 100%) !important;\n    color: #FFFFFF !important;\n    -webkit-text-fill-color: #FFFFFF !important;\n    font-size: 15px !important;\n    font-weight: 900 !important;\n    box-shadow: 0 10px 24px rgba(6, 26, 64, 0.22) !important;\n}\ndiv[data-testid="column"]:has(.nav-signup-marker-v225) div[data-testid="stButton"] > button p::before{\n    content: "👥";\n    margin-right: 8px;\n    font-size: 15px;\n}\n\n/* Streamlit paragraph inside buttons must also be centered */\ndiv[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223) div[data-testid="stButton"] > button p,\ndiv[data-testid="stHorizontalBlock"]:has(.public-brand-v220) div[data-testid="stButton"] > button p,\ndiv[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225) div[data-testid="stButton"] > button p{\n    margin: 0 !important;\n    padding: 0 !important;\n    line-height: 1 !important;\n    display: inline-flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    gap: 0 !important;\n    color: inherit !important;\n    -webkit-text-fill-color: inherit !important;\n}\n\n/* Prevent old spacing rules from moving actions */\n.nav-login-marker-v225,\n.nav-signup-marker-v225{\n    display: none !important;\n    height: 0 !important;\n    margin: 0 !important;\n    padding: 0 !important;\n}\n\n/* Mobile: allow wrapping rather than breaking alignment */\n@media(max-width: 900px){\n    div[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v223),\n    div[data-testid="stHorizontalBlock"]:has(.public-brand-v220),\n    div[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v225){\n        height: auto !important;\n        min-height: 76px !important;\n        flex-wrap: wrap !important;\n    }\n}\n@media(max-width: 768px){\n    :root{ --v245-page-width: calc(100% - 24px); }\n}\n@media(max-width: 480px){\n    :root{ --v245-page-width: calc(100% - 16px); }\n}\n</style>\n', unsafe_allow_html=True)


# v246 actual navbar action links/buttons CSS
st.markdown('\n<style>\n/* v246: actual navbar action links/buttons only */\ndiv[data-testid="stHorizontalBlock"]:has(.nav-actions-v246){\n    width: calc(100% - 32px) !important;\n    max-width: 1760px !important;\n    height: 76px !important;\n    min-height: 76px !important;\n    margin: 6px auto 10px auto !important;\n    padding: 10px 18px !important;\n    display: flex !important;\n    align-items: center !important;\n    border: 1px solid #E2E8F0 !important;\n    border-radius: 18px !important;\n    background: rgba(255,255,255,.98) !important;\n    box-shadow: 0 12px 32px rgba(15,23,42,.08) !important;\n    box-sizing: border-box !important;\n    overflow: visible !important;\n}\n\ndiv[data-testid="stHorizontalBlock"]:has(.nav-actions-v246) > div{\n    height: 56px !important;\n    min-height: 56px !important;\n    display: flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    padding-top: 0 !important;\n    padding-bottom: 0 !important;\n    margin-top: 0 !important;\n    margin-bottom: 0 !important;\n    box-sizing: border-box !important;\n}\n\n.nav-actions-v246{\n    width: 100% !important;\n    height: 56px !important;\n    display: flex !important;\n    align-items: center !important;\n    justify-content: flex-end !important;\n    gap: 12px !important;\n    flex-shrink: 0 !important;\n    margin: 0 !important;\n    padding: 0 !important;\n    box-sizing: border-box !important;\n}\n\n.nav-actions-v246 a,\n.nav-actions-v246 a:visited,\n.nav-actions-v246 a:hover,\n.nav-actions-v246 a:active{\n    text-decoration: none !important;\n}\n\n.login-button-v246{\n    height: 48px !important;\n    min-height: 48px !important;\n    padding: 0 22px !important;\n    border-radius: 12px !important;\n    border: 1px solid #CBD5E1 !important;\n    background: #FFFFFF !important;\n    color: #0F172A !important;\n    -webkit-text-fill-color: #0F172A !important;\n    font-size: 15px !important;\n    font-weight: 800 !important;\n    display: inline-flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    gap: 8px !important;\n    line-height: 1 !important;\n    text-decoration: none !important;\n    white-space: nowrap !important;\n    box-shadow: none !important;\n    box-sizing: border-box !important;\n}\n\n.partner-signup-button-v246{\n    height: 48px !important;\n    min-height: 48px !important;\n    padding: 0 24px !important;\n    border-radius: 12px !important;\n    border: none !important;\n    background: linear-gradient(135deg, #061A40, #123B8A) !important;\n    color: #FFFFFF !important;\n    -webkit-text-fill-color: #FFFFFF !important;\n    font-size: 15px !important;\n    font-weight: 800 !important;\n    display: inline-flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    gap: 8px !important;\n    line-height: 1 !important;\n    text-decoration: none !important;\n    white-space: nowrap !important;\n    box-shadow: 0 10px 24px rgba(6, 26, 64, 0.22) !important;\n    box-sizing: border-box !important;\n}\n\n.partner-signup-button-v246:hover{\n    background: linear-gradient(135deg, #07172C, #0B2E73) !important;\n    transform: translateY(-1px) !important;\n}\n\n.login-button-v246:hover{\n    border-color: #123B8A !important;\n    color: #123B8A !important;\n    -webkit-text-fill-color: #123B8A !important;\n    background: #F8FBFF !important;\n}\n\n.nav-action-icon-v246{\n    width: 18px !important;\n    height: 18px !important;\n    min-width: 18px !important;\n    display: inline-flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    flex-shrink: 0 !important;\n    line-height: 1 !important;\n    font-size: 17px !important;\n}\n\n/* Do not allow global navbar link resets to flatten action buttons */\ndiv[data-testid="stHorizontalBlock"]:has(.nav-actions-v246) .nav-actions-v246 a{\n    all: unset;\n    cursor: pointer !important;\n}\ndiv[data-testid="stHorizontalBlock"]:has(.nav-actions-v246) .nav-actions-v246 .login-button-v246{\n    height: 48px !important;\n    padding: 0 22px !important;\n    border-radius: 12px !important;\n    border: 1px solid #CBD5E1 !important;\n    background: #FFFFFF !important;\n    color: #0F172A !important;\n    -webkit-text-fill-color: #0F172A !important;\n    font-size: 15px !important;\n    font-weight: 800 !important;\n    display: inline-flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    gap: 8px !important;\n    line-height: 1 !important;\n    text-decoration: none !important;\n    white-space: nowrap !important;\n    box-sizing: border-box !important;\n}\ndiv[data-testid="stHorizontalBlock"]:has(.nav-actions-v246) .nav-actions-v246 .partner-signup-button-v246{\n    height: 48px !important;\n    padding: 0 24px !important;\n    border-radius: 12px !important;\n    border: none !important;\n    background: linear-gradient(135deg, #061A40, #123B8A) !important;\n    color: #FFFFFF !important;\n    -webkit-text-fill-color: #FFFFFF !important;\n    font-size: 15px !important;\n    font-weight: 800 !important;\n    display: inline-flex !important;\n    align-items: center !important;\n    justify-content: center !important;\n    gap: 8px !important;\n    line-height: 1 !important;\n    text-decoration: none !important;\n    white-space: nowrap !important;\n    box-shadow: 0 10px 24px rgba(6, 26, 64, 0.22) !important;\n    box-sizing: border-box !important;\n}\n\n/* Keep old marker-based rules from affecting the new action buttons */\n.nav-login-marker-v225,\n.nav-signup-marker-v225{\n    display: none !important;\n}\n\n/* Mobile: keep buttons as boxes, allow navbar to wrap cleanly */\n@media(max-width: 900px){\n    div[data-testid="stHorizontalBlock"]:has(.nav-actions-v246){\n        height: auto !important;\n        min-height: 76px !important;\n        flex-wrap: wrap !important;\n    }\n    .nav-actions-v246{\n        justify-content: center !important;\n        flex-wrap: wrap !important;\n    }\n}\n@media(max-width: 768px){\n    div[data-testid="stHorizontalBlock"]:has(.nav-actions-v246){\n        width: calc(100% - 24px) !important;\n    }\n}\n@media(max-width: 480px){\n    div[data-testid="stHorizontalBlock"]:has(.nav-actions-v246){\n        width: calc(100% - 16px) !important;\n    }\n    .login-button-v246,\n    .partner-signup-button-v246{\n        width: 100% !important;\n    }\n}\n</style>\n', unsafe_allow_html=True)
