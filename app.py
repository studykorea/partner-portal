...
def force_single_tab_navigation_v186():
    """v192: disabled browser JS; top menu uses Streamlit buttons only."""
    return
...
def handle_home_query_navigation_v69():
    """v192: disabled URL query navigation. Use Streamlit buttons only."""
    return

def auth_query_suffix_v104(prefix="&"):
    """v192: disabled auth URL suffix so internal links do not create new browser tabs."""
    return ""
...
def browser_login_nav_sync_v163():
    """v192: disabled browser localStorage/JS sync to prevent unwanted browser tabs."""
    return
...
def header():
    ...
    """
    # v192: no browser or URL-link navigation in header.
