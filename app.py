...
def _route_from_nav_query_v252():
    try:
        ...
        if nav_value in route_map:
            st.session_state["page"] = route_map[nav_value]
    except Exception:
        pass

_route_from_nav_query_v252()
...
def header():
    ...
    if logged_in_v187:
        ...
        # Public view
        # v251: Real navbar HTML structure with working query-param routing.
        st.markdown('\n<style>\n/* v251 REAL NAVBAR STRUCTURE FIX */\n/* Only navbar brand/buttons + navbar-hero spacing. No card/filter/admin/admission logic changed. */\n\n:root{\n  --site-container-width-v251: calc(100% - 32px);\n  --site-container-max-v251: 1760px;\n}\n\n/* Remove global top padding that creates big white gaps */\n.main .block-container,\nsection.main > div,\ndiv.block-container{\n  padding-top: 0 !important;\n}\n\n/* Header + Navbar */\n.site-header-v251{\n  width: var(--site-container-width-v251);\n  max-width: var(--site-container-max-v251);\n  margin: 4px auto 6px auto;\n  padding: 0;\n  box-sizing: border-box;\n}\n\n.navbar-v251{\n  width: 100%;\n  height: 72px;\n  min-height: 72px;\n  padding: 0 18px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 18px;\n  border: 1px solid #E2E8F0;\n  border-radius: 18px;\n  background: #FFFFFF;\n  box-shadow: 0 8px 22px rgba(15, 23, 42, 0.075);\n  box-sizing: border-box;\n}\n\n.navbar-v251 a{\n  text-decoration: none !important;\n  box-sizing: border-box;\n}\n\n.navbar-brand-v251{\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  height: 56px;\n  flex: 0 0 auto;\n  min-width: 230px;\n}\n\n.brand-logo-v251{\n  width: 52px;\n  height: 52px;\n  min-width: 52px;\n  min-height: 52px;\n  border-radius: 14px;\n  background: linear-gradient(135deg, #3146B7 0%, #061A40 100%);\n  color: #FFFFFF;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 14px;\n  font-weight: 950;\n  letter-spacing: -0.04em;\n  line-height: 1;\n  box-shadow: 0 8px 18px rgba(6, 26, 64, 0.20);\n  overflow: hidden;\n}\n\n.brand-copy-v251{\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: flex-start;\n  line-height: 1.05;\n  min-width: 0;\n}\n\n.brand-title-v251{\n  font-size: 18px;\n  font-weight: 900;\n  color: #0F172A;\n  white-space: nowrap;\n  line-height: 1.05;\n}\n\n.brand-subtitle-v251{\n  margin-top: 4px;\n  font-size: 13px;\n  font-weight: 750;\n  color: #475569;\n  white-space: nowrap;\n  line-height: 1.05;\n}\n\n.nav-menu-v251{\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 8px;\n  flex: 1 1 auto;\n  min-width: 0;\n  height: 56px;\n}\n\n.nav-menu-v251 a{\n  height: 44px;\n  padding: 0 13px;\n  border-radius: 12px;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  color: #0F172A;\n  font-size: 15px;\n  font-weight: 750;\n  white-space: nowrap;\n  line-height: 1;\n}\n\n.nav-menu-v251 a:hover,\n.nav-menu-v251 a.active{\n  background: #EEF4FF;\n  color: #123B8A;\n}\n\n.nav-actions-v251{\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  gap: 12px;\n  flex: 0 0 auto;\n  height: 56px;\n}\n\n.nav-login-btn-v251,\n.nav-signup-btn-v251{\n  height: 48px;\n  min-height: 48px;\n  border-radius: 12px;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  gap: 8px;\n  line-height: 1;\n  white-space: nowrap;\n  font-size: 15px;\n  font-weight: 850;\n  box-sizing: border-box;\n}\n\n.nav-login-btn-v251{\n  padding: 0 22px;\n  border: 1px solid #CBD5E1;\n  background: #FFFFFF;\n  color: #0F172A;\n  box-shadow: none;\n}\n\n.nav-signup-btn-v251{\n  padding: 0 24px;\n  border: 1px solid transparent;\n  background: linear-gradient(135deg, #061A40, #123B8A);\n  color: #FFFFFF !important;\n  box-shadow: 0 10px 24px rgba(6, 26, 64, 0.22);\n}\n\n.nav-login-btn-v251:hover{\n  border-color: #123B8A;\n  color: #123B8A;\n  background: #F8FBFF;\n}\n\n.nav-signup-btn-v251:hover{\n  background: linear-gradient(135deg, #07172C, #0B2E73);\n  transform: translateY(-1px);\n}\n\n.nav-icon-v251{\n  width: 18px;\n  height: 18px;\n  min-width: 18px;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  line-height: 1;\n  font-size: 16px;\n}\n\n/* TIGHT navbar -> hero spacing. Target only actual following hero sections. */\n.site-header-v251 + div,\n.site-header-v251 + section{\n  margin-top: 0 !important;\n  padding-top: 0 !important;\n}\n\n.top-nav-button-shell-v187,\n.navbar-wrapper{\n  margin: 0 !important;\n  padding: 0 !important;\n}\n\n/* If old navbar columns remain anywhere, hide them */\ndiv[data-testid="stHorizontalBlock"]:has(.nav-v248-marker),\ndiv[data-testid="stHorizontalBlock"]:has(.premium-public-brand-v248),\ndiv[data-testid="stHorizontalBlock"]:has(.nav-login-marker-v248),\ndiv[data-testid="stHorizontalBlock"]:has(.nav-signup-marker-v248){\n  display: none !important;\n  height: 0 !important;\n  min-height: 0 !important;\n  margin: 0 !important;\n  padding: 0 !important;\n  overflow: hidden !important;\n}\n\n/* Hero wrapper spacing */\n.hero-wrapper,\n.hero-container,\n.hero-section-wrapper,\n.public-hero-wrapper,\ndiv:has(> .public-hero-section-v223),\ndiv:has(> .hero-section),\ndiv:has(> .hero-slider){\n  margin-top: 0 !important;\n  padding-top: 0 !important;\n  margin-bottom: 8px !important;\n  padding-bottom: 0 !important;\n}\n\n.public-hero-section-v223,\n.hero-section,\n.hero-slider{\n  margin-top: 0 !important;\n  margin-bottom: 0 !important;\n}\n\n/* Filter should stay near hero */\n.filter-wrapper,\n.filter-section,\n.universities-filter-wrapper,\ndiv:has(> .filter-card),\ndiv:has(> .universities-filter-card),\ndiv:has(> .premium-filter-card-v229){\n  margin-top: 0 !important;\n  padding-top: 0 !important;\n}\n\n.filter-card,\n.universities-filter-card,\n.premium-filter-card-v229{\n  margin-top: 0 !important;\n}\n\n@media(max-width: 1180px){\n  .navbar-v251{\n    height: auto;\n    min-height: 72px;\n    flex-wrap: wrap;\n    padding: 10px 14px;\n  }\n  .nav-menu-v251{\n    order: 3;\n    width: 100%;\n    height: auto;\n    flex-wrap: wrap;\n  }\n  .navbar-brand-v251{ min-width: auto; }\n  .nav-actions-v251{ margin-left: auto; }\n}\n\n@media(max-width: 768px){\n  :root{ --site-container-width-v251: calc(100% - 24px); }\n}\n\n@media(max-width: 520px){\n  :root{ --site-container-width-v251: calc(100% - 16px); }\n  .nav-actions-v251{ width: 100%; }\n  .nav-login-btn-v251,\n  .nav-signup-btn-v251{ flex: 1 1 0; }\n}\n</style>\n', unsafe_allow_html=True)
        active_home = "active" if current == "Home" else ""
        active_universities = "active" if current == "Universities" else ""
        active_eligibility = "active" if current == "Eligibility Check" else ""
        active_tuition = "active" if current == "Tuition & Scholarship" else ""
        active_contact = "active" if current == "Contact Us" else ""
        st.markdown(f"""
        <header class="site-header-v251">
          <div class="navbar-v251">
            <a href="?nav=home" target="_self" class="navbar-brand-v251">
              <span class="brand-logo-v251">KUA</span>
              <span class="brand-copy-v251">
                <span class="brand-title-v251">Korea University</span>
                <span class="brand-subtitle-v251">Admissions</span>
              </span>
            </a>

            <nav class="nav-menu-v251">
              <a href="?nav=home" target="_self" class="{active_home}">Home</a>
              <a href="?nav=universities" target="_self" class="{active_universities}">Universities ▸</a>
              <a href="?nav=eligibility" target="_self" class="{active_eligibility}">Eligibility Check</a>
              <a href="?nav=tuition" target="_self" class="{active_tuition}">Tuition Fees</a>
              <a href="?nav=contact" target="_self" class="{active_contact}">Contact Us</a>
              <a href="?nav=mou" target="_self">MoU Contact</a>
            </nav>

            <div class="nav-actions-v251">
              <a href="?nav=login" target="_self" class="nav-login-btn-v251">
                <span class="nav-icon-v251">👤</span>
                <span>Login</span>
              </a>
              <a href="?nav=signup" target="_self" class="nav-signup-btn-v251">
                <span class="nav-icon-v251">👥</span>
