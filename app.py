...
# v256 safety guard based on stable v244
BASE = globals().get("BASE", Path(__file__).resolve().parent)
DATA = globals().get("DATA", BASE / "data")
ASSETS = globals().get("ASSETS", BASE / "assets")
